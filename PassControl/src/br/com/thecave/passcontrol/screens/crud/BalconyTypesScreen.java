 ...
 */
public class BalconyTypesScreen extends javax.swing.JFrame 
{
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Id do tipo de guichê");
        ...
        tfType.setToolTipText("Insira o nome do usuário!");
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(tfType, javax.swing.GroupLayout.PREFERRED_SIZE, 288, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(elType)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(tfType, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(elType, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    {
        BalconyTypesBean bean = writeBeanFromScreen();
    ...
    {
        typeValid = Validation.validarCampo(tfType, jLabel1);
    }
    //==============================================================================
    public BalconyTypesBean writeBeanFromScreen()
    {
    ...
    private void selectBean() 
    {
        ...
        BalconyTypesBean bean = null;
        if( ret != null)
        {
            String item = cbIdGuiche.getSelectedItem().toString();
            int index = Integer.parseInt(item);
            bean = ServerComunication.selectBalconyTypes(index);
    ...
    //==============================================================================
    public void writeScreenFromBean(BalconyTypesBean bean)
    {
        if(bean != null)
        {
            tfType.setText(bean.getType());            
        }        
    }
    //==============================================================================
}
